                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    <p style="color:#455056; font-size:18px;line-height:28px; margin:0;">
                                        Welcome to {{ $siteName }}, {{ $userName }}!
                                    </p>
                                    <br>
                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                        Thank you for creating an account with us. Start shopping and enjoy exclusive offers and updates tailored just for you.
                                    </p>
                                    <br>
